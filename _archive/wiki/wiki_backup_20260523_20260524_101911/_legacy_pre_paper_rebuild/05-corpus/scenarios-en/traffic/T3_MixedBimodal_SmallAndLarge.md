## Scenario T3 — T3_MixedBimodal_SmallAndLarge

### 1. Overview

- **Scenario ID:** T3
- **Name:** T3_MixedBimodal_SmallAndLarge
- **Family:** Traffic
- **Settings file:** `corpus_v1/07_traffic/T3_MixedBimodal_SmallAndLarge.settings`

**Objective**

Mixed bimodal: small and large messages from two generators. Tests protocol under heterogeneous payload sizes.
