## Scenario T10 — T10_HighRateLowSpeed_Congestion

### 1. Overview

- **Scenario ID:** T10
- **Name:** T10_HighRateLowSpeed_Congestion
- **Family:** Traffic
- **Settings file:** `corpus_v1/07_traffic/T10_HighRateLowSpeed_Congestion.settings`

**Objective**

High rate and low transmit speed. Congestion regime; queue buildup.
