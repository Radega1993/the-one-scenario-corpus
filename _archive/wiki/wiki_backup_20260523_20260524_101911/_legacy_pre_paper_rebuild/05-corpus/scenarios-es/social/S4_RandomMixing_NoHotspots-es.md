## Escenario S4 — S4_RandomMixing_NoHotspots

### 1. Visión general

- **Scenario ID:** S4
- **Nombre:** S4_RandomMixing_NoHotspots
- **Familia:** Social
- **Fichero settings:** `corpus_v1/06_social/S4_RandomMixing_NoHotspots.settings`

**Objetivo**

Mezcla aleatoria sin hotspots. Distribución uniforme de contactos; baseline para comparar con escenarios estructurados (S1, S3, S6).
...
- **Más similares (top 3):**
  - D7_HighLoad_TrafficStorm — r ≈ **0.87**
  - T9_BufferStress_SmallBufferHighTraffic — r ≈ **0.86**
  - T1_ManySmallMsgs_HighRate — r ≈ **0.79**
- **Más diferentes (top 3)** (menor |r|):
  - S1_StrongCommunities_SeparateClusters — r ≈ **0.00**
  - R6_SparseLongRange — r ≈ **0.01**
  - C2_ExamDay_LongStays — r ≈ **0.02**
...
| Métrica | Valor |
|--------|-------|
| delivery_ratio | 0.0374 |
| latency_mean | 10118.7692 |
| overhead_ratio | 39.6923 |
| drop_ratio | 1.7528735632183907 |
