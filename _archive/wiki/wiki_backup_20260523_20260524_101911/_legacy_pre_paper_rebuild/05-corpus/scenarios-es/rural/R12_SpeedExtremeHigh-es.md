## Escenario R12 — R12_SpeedExtremeHigh

### 1. Visión general

- **Scenario ID:** R12  
- **Nombre:** R12_SpeedExtremeHigh  
- **Familia:** Rural  
- **Fichero settings:** `corpus_v1/04_rural/R12_SpeedExtremeHigh.settings`

**Objetivo**

12–15 m/s en mundo pequeño: encuentros muy frecuentes. Velocidad máxima.
...
|---------|-------|------------|
| world_area | 7500000 | Área total de simulación (m^2) |
| aspect_ratio | 0.8333 | min(width,height)/max(width,height) |
| N | 40 | Nodos totales |
| nrofHostGroups | 1 | Número de host groups |
| speed_mean | 13.5 | Velocidad media configurada (m/s) |
| wait_mean | 17.5 | Tiempo medio de pausa/espera (s) |
...
| event_interval_mean | 60 | Media del intervalo de Events1 |
...
RandomWaypoint, velocidad 12–15 m/s, esperas cortas.
