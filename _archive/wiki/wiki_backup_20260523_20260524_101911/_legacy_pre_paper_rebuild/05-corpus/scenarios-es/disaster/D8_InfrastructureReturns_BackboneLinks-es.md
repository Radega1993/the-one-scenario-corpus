## Escenario D8 — D8_InfrastructureReturns_BackboneLinks

### 1. Visión general

- **Scenario ID:** D8  
- **Nombre:** D8_InfrastructureReturns_BackboneLinks  
- **Familia:** Disaster  
- **Fichero settings:** `corpus_v1/05_disaster/D8_InfrastructureReturns_BackboneLinks.settings`

**Objetivo**

Disposición disaster particionada donde enlaces de infraestructura/backbone reaparecen a mitad de simulación por eventos externos.
...
Particiones cluster con ExternalEventsQueue para enlaces tardíos entre particiones.
