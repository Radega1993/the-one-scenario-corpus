## Escenario T8 — T8_BurstTraffic_TimeWindows

### 1. Visión general

- **Scenario ID:** T8
- **Nombre:** T8_BurstTraffic_TimeWindows
- **Familia:** Traffic
- **Fichero settings:** `corpus_v1/07_traffic/T8_BurstTraffic_TimeWindows.settings`

**Objetivo**

Tráfico en ráfagas en ventanas temporales. Dos generadores; patrón de carga bursty.
