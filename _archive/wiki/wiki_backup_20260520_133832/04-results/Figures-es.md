...
Todas las figuras se generan con `run_analysis.py --phase figures` (y `outputs` para el heatmap de outputs). Están en **`analysis/figures/`** (PNG y PDF). Los enlaces apuntan al repo; si la wiki se publica desde un clon, puedes subir estas imágenes a la wiki o usar URLs raw.

**Ruta en el repo:** `analysis/figures/`  
**URL raw:** `https://raw.githubusercontent.com/Radega1993/the-one-scenario-corpus/main/analysis/figures/<nombre>.png`

---

## 1. Heatmap — Pearson (vectores de features)

Matriz de correlación entre **vectores de features** de escenarios (60x60). Cada celda es el r de Pearson entre dos escenarios. Rojo = correlación positiva alta; azul = negativa. Valores altos fuera de la diagonal indican pares linealmente similares en el espacio de parámetros.

![Heatmap Pearson](https://raw.githubusercontent.com/Radega1993/the-one-scenario-corpus/main/analysis/figures/heatmap_pearson.png)

*Fichero:* `heatmap_pearson.png`
...
![Heatmap Spearman](https://raw.githubusercontent.com/Radega1993/the-one-scenario-corpus/main/analysis/figures/heatmap_spearman.png)

*Fichero:* `heatmap_spearman.png`

---

## 3. Histograma — correlaciones Pearson

Distribución del **|r| de Pearson** entre todos los pares de escenarios (1770 pares). Muestra cuántos pares caen en cada intervalo. Objetivo: la mayor masa por debajo de 0,7.

![Histograma Pearson](https://raw.githubusercontent.com/Radega1993/the-one-scenario-corpus/main/analysis/figures/histogram_correlations_pearson.png)

*Fichero:* `histogram_correlations_pearson.png`
...
![Histograma Spearman](https://raw.githubusercontent.com/Radega1993/the-one-scenario-corpus/main/analysis/figures/histogram_correlations_spearman.png)

*Fichero:* `histogram_correlations_spearman.png`
...
![Scatter PCA](https://raw.githubusercontent.com/Radega1993/the-one-scenario-corpus/main/analysis/figures/scatter_pca_regression.png)

*Fichero:* `scatter_pca_regression.png`
...
![Scatter par max r](https://raw.githubusercontent.com/Radega1993/the-one-scenario-corpus/main/analysis/figures/scatter_max_r_pair_regression.png)

*Fichero:* `scatter_max_r_pair_regression.png`
...
![Heatmap outputs](https://raw.githubusercontent.com/Radega1993/the-one-scenario-corpus/main/analysis/figures/heatmap_pearson_outputs.png)

*Fichero:* `heatmap_pearson_outputs.png`
...
Enlaces: [reports/ en el repo](https://github.com/Radega1993/the-one-scenario-corpus/tree/main/analysis/reports)
...
| Fichero | Descripción |
|---------|-------------|
| **features.csv** | Una fila por escenario, columnas = features (46). |
| **features_normalized.csv** | Features normalizados (z-score). |
| **normalization_params.csv** | Media y desv. típica por feature. |
| **correlation_pearson.csv**, **correlation_spearman.csv** | Matrices 60x60 (vectores de features). |
| **distance_cosine.csv**, **distance_euclidean.csv** | Matrices 60x60 de distancias. |
...
Enlaces: [data/ en el repo](https://github.com/Radega1993/the-one-scenario-corpus/tree/main/analysis/data)
