## Escenario T2 — T2_FewHugeMsgs_LowRate

### 1. Visión general

- **Scenario ID:** T2
- **Nombre:** T2_FewHugeMsgs_LowRate
- **Familia:** Traffic
- **Fichero settings:** `corpus_v1/07_traffic/T2_FewHugeMsgs_LowRate.settings`

**Objetivo**

Pocos mensajes grandes con baja tasa. Estresa capacidad de buffer y tiempo de transferencia.
...
| msgTtl | 10000 |  |
| event_interval_mean | 900 |  |
| event_size_mean | 3000000 |  |
