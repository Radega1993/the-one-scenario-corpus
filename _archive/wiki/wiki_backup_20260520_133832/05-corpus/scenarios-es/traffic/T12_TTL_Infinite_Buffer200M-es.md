## Escenario T12 — T12_TTL_Infinite_Buffer200M

### 1. Visión general

- **Scenario ID:** T12
- **Nombre:** T12_TTL_Infinite_Buffer200M
- **Familia:** Traffic
- **Fichero settings:** `corpus_v1/07_traffic/T12_TTL_Infinite_Buffer200M.settings`

**Objetivo**

TTL infinito y buffer 200 MB. Sin expiración; prueba el protocolo bajo restricciones relajadas.
...
- **Más similares (top 3):**
  - T14_Buffer_200M — r ≈ **0.89**
  - T6_UniformSources_RandomFromTo — r ≈ **0.51**
  - R10_TinyRange_5m — r ≈ **0.34**
- **Más diferentes (top 3)** (menor |r|):
  - R6_SparseLongRange — r ≈ **0.00**
  - D7_HighLoad_TrafficStorm — r ≈ **-0.00**
  - T8_BurstTraffic_TimeWindows — r ≈ **0.00**
...
| Métrica | Valor |
|--------|-------|
| delivery_ratio | 0.0458 |
| latency_mean | 20102.7385 |
| overhead_ratio | 31.3846 |
| drop_ratio | 0.0 |
