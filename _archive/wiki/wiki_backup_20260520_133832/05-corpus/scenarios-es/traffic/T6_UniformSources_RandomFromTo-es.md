## Escenario T6 — T6_UniformSources_RandomFromTo

### 1. Visión general

- **Scenario ID:** T6
- **Nombre:** T6_UniformSources_RandomFromTo
- **Familia:** Traffic
- **Fichero settings:** `corpus_v1/07_traffic/T6_UniformSources_RandomFromTo.settings`

**Objetivo**

Fuentes uniformes: pares origen–destino aleatorios. Patrón de tráfico baseline.
...
- **Más similares (top 3):**
  - R8_IntermittentPower — r ≈ **0.74**
  - R10_TinyRange_5m — r ≈ **0.71**
  - T1_ManySmallMsgs_HighRate — r ≈ **0.70**
- **Más diferentes (top 3)** (menor |r|):
  - C6_EmergencyDrill_Evacuation — r ≈ **0.01**
  - D2_PartitionedCity_MuleBridge — r ≈ **-0.03**
...
| Métrica | Valor |
|--------|-------|
| delivery_ratio | 0.0143 |
| latency_mean | 8596.06 |
| overhead_ratio | 37.6 |
| drop_ratio | 1.0342857142857143 |
