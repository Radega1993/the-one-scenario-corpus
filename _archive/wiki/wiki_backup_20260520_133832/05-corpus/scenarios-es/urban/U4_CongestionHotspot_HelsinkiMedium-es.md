## Escenario U4 — U4_CongestionHotspot_HelsinkiMedium

### 1. Visión general

- **Scenario ID:** U4
- **Nombre:** U4_CongestionHotspot_HelsinkiMedium
- **Familia:** Urban
- **Fichero settings:** `corpus_v1/01_urban/U4_CongestionHotspot_HelsinkiMedium.settings`

**Objetivo**

Punto de congestión: rango reducido y oficinas más agrupadas. Prueba DTN bajo presión de contactos localizada.
