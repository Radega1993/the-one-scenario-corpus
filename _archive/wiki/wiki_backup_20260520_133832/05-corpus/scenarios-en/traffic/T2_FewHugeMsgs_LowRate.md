## Scenario T2 — T2_FewHugeMsgs_LowRate

### 1. Overview

- **Scenario ID:** T2
- **Name:** T2_FewHugeMsgs_LowRate
- **Family:** Traffic
- **Settings file:** `corpus_v1/07_traffic/T2_FewHugeMsgs_LowRate.settings`

**Objective**

Few huge messages with low rate. Stresses buffer capacity and transfer time.
