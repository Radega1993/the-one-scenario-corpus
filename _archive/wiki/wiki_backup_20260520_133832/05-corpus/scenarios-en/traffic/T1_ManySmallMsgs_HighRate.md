## Scenario T1 — T1_ManySmallMsgs_HighRate

### 1. Overview

- **Scenario ID:** T1
- **Name:** T1_ManySmallMsgs_HighRate
- **Family:** Traffic
- **Settings file:** `corpus_v1/07_traffic/T1_ManySmallMsgs_HighRate.settings`

**Objective**

Many small messages with high generation rate. Stresses buffer turnover and contact utilisation.
