## Scenario T7 — T7_TargetedToHubs_FewDestinations

### 1. Overview

- **Scenario ID:** T7
- **Name:** T7_TargetedToHubs_FewDestinations
- **Family:** Traffic
- **Settings file:** `corpus_v1/07_traffic/T7_TargetedToHubs_FewDestinations.settings`

**Objective**

Hub-target traffic: few destinations. Concentrates traffic to hub nodes.
