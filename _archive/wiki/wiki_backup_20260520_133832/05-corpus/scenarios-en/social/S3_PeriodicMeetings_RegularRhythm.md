## Scenario S3 — S3_PeriodicMeetings_RegularRhythm

### 1. Overview

- **Scenario ID:** S3
- **Name:** S3_PeriodicMeetings_RegularRhythm
- **Family:** Social
- **Settings file:** `corpus_v1/06_social/S3_PeriodicMeetings_RegularRhythm.settings`

**Objective**

Periodic meetings with regular rhythm. Predictable contact patterns; tests protocol sensitivity to temporal regularity.
