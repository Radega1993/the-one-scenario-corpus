## Scenario U5 — U5_WorkdayShort_HelsinkiMedium

### 1. Overview

- **Scenario ID:** U5
- **Name:** U5_WorkdayShort_HelsinkiMedium
- **Family:** Urban
- **Settings file:** `corpus_v1/01_urban/U5_WorkdayShort_HelsinkiMedium.settings`

**Objective**

Short workday (4 h). Compressed activity window alters contact patterns and delivery opportunities.
...
| workDayLength | 14400 | Work day length (s) if WorkingDayMovement |
...
Event rate and TTL interact with mobility: short TTL (U3) favours fast relays; long TTL (U2) tolerates sparse contacts. Buffer and transmit speed affect congestion under high load.
...
- **Most similar (top 3):**
  - V4_CarOwnership_0_HelsinkiMedium — r ≈ **0.87**
  - U6_OfficeWaitHeavyTail_HelsinkiMedium — r ≈ **0.86**
  - U4_CongestionHotspot_HelsinkiMedium — r ≈ **0.80**
- **Most different (top 3)** (smallest |r|):
  - C6_EmergencyDrill_Evacuation — r ≈ **0.00**
  - D5_UAVMule_FastRoute_HelsinkiMedium — r ≈ **-0.02**
  - S1_StrongCommunities_SeparateClusters — r ≈ **0.02**
...
| Metric | Value |
|--------|-------|
| delivery_ratio | 0.1613 |
| latency_mean | 7978.3449 |
| overhead_ratio | 80.9195 |
| drop_ratio | 13.4066985645933 |
