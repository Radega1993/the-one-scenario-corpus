## Escenario T10 — T10_HighRateLowSpeed_Congestion

### 1. Visión general

- **Scenario ID:** T10
- **Nombre:** T10_HighRateLowSpeed_Congestion
- **Familia:** Traffic
- **Fichero settings:** `corpus_v1/07_traffic/T10_HighRateLowSpeed_Congestion.settings`

**Objetivo**

Alta tasa y baja velocidad de transmisión. Régimen de congestión; acumulación de colas.
...
| transmitRange | 7 |  |
| bufferSize | 20000000 |  |
| transmitSpeed | 200000 |  |
| msgTtl | 10000 |  |
| event_interval_mean | 25 |  |
| event_size_mean | 190000 |  |
...
- **Más similares (top 3):**
  - T15_TransmitSpeed_256k — r ≈ **0.86**
  - R6_SparseLongRange — r ≈ **0.47**
  - T9_BufferStress_SmallBufferHighTraffic — r ≈ **0.45**
...
| Métrica | Valor |
|--------|-------|
| delivery_ratio | 0.0108 |
| latency_mean | 7291.5789 |
| overhead_ratio | 13.6842 |
| drop_ratio | 0.696590909090909 |
