## Escenario T1 — T1_ManySmallMsgs_HighRate

### 1. Visión general

- **Scenario ID:** T1
- **Nombre:** T1_ManySmallMsgs_HighRate
- **Familia:** Traffic
- **Fichero settings:** `corpus_v1/07_traffic/T1_ManySmallMsgs_HighRate.settings`

**Objetivo**

Muchos mensajes pequeños con alta tasa de generación. Estresa rotación de buffer y utilización de contactos.
...
- **Más similares (top 3):**
  - S4_RandomMixing_NoHotspots — r ≈ **0.79**
  - T9_BufferStress_SmallBufferHighTraffic — r ≈ **0.77**
  - T6_UniformSources_RandomFromTo — r ≈ **0.70**
- **Más diferentes (top 3)** (menor |r|):
  - R4_ParkRangers_HelsinkiMedium — r ≈ **0.01**
  - D8_InfrastructureReturns_BackboneLinks — r ≈ **-0.01**
  - D4_MedicalTriage_TwoClasses — r ≈ **-0.03**
...
| Métrica | Valor |
|--------|-------|
| delivery_ratio | 0.0279 |
| latency_mean | 9117.8914 |
| overhead_ratio | 32.0156 |
| drop_ratio | 1.2441632118699542 |
