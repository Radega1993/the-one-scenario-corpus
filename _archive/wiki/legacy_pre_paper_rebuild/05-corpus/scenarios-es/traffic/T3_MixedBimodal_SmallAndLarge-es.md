## Escenario T3 — T3_MixedBimodal_SmallAndLarge

### 1. Visión general

- **Scenario ID:** T3
- **Nombre:** T3_MixedBimodal_SmallAndLarge
- **Familia:** Traffic
- **Fichero settings:** `corpus_v1/07_traffic/T3_MixedBimodal_SmallAndLarge.settings`

**Objetivo**

Mezcla bimodal: mensajes pequeños y grandes de dos generadores. Prueba el protocolo bajo tamaños de payload heterogéneos.
...
| msgTtl | 10000 |  |
| event_interval_mean | 60 |  |
| event_size_mean | 6000 |  |
...
- **Más similares (top 3):**
  - C4_Stadium_IngressEgress — r ≈ **0.48**
  - T8_BurstTraffic_TimeWindows — r ≈ **0.46**
  - D4_MedicalTriage_TwoClasses — r ≈ **0.42**
...
| Métrica | Valor |
|--------|-------|
| delivery_ratio | 0.0205 |
| latency_mean | 9614.3529 |
| overhead_ratio | 44.4706 |
| drop_ratio | 1.2671480144404332 |
