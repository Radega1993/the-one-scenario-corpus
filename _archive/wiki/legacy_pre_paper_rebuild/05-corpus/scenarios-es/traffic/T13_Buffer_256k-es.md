## Escenario T13 — T13_Buffer_256k

### 1. Visión general

- **Scenario ID:** T13
- **Nombre:** T13_Buffer_256k
- **Familia:** Traffic
- **Fichero settings:** `corpus_v1/07_traffic/T13_Buffer_256k.settings`

**Objetivo**

Buffer pequeño (256 KB). Estrés severo de buffer.
...
| transmitRange | 6 |  |
| bufferSize | 256000 |  |
| transmitSpeed | 2200000 |  |
| msgTtl | 30 |  |
| event_interval_mean | 100 |  |
| event_size_mean | 27500 |  |
...
- **Más similares (top 3):**
  - D9_Critical_1minTTL — r ≈ **0.92**
  - T11_TTL_1min — r ≈ **0.90**
  - R7_SparseTinyBuffer — r ≈ **0.85**
...
| Métrica | Valor |
|--------|-------|
| delivery_ratio | 0.0069 |
| latency_mean | 7036.0 |
| overhead_ratio | 17.6667 |
| drop_ratio | 0.6889400921658986 |
