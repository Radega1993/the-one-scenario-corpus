## Escenario T7 — T7_TargetedToHubs_FewDestinations

### 1. Visión general

- **Scenario ID:** T7
- **Nombre:** T7_TargetedToHubs_FewDestinations
- **Familia:** Traffic
- **Fichero settings:** `corpus_v1/07_traffic/T7_TargetedToHubs_FewDestinations.settings`

**Objetivo**

Tráfico hub-target: pocos destinos. Concentra tráfico en nodos hub.
...
- **Más similares (top 3):**
  - D4_MedicalTriage_TwoClasses — r ≈ **0.75**
  - R8_IntermittentPower — r ≈ **0.22**
  - T6_UniformSources_RandomFromTo — r ≈ **0.20**
...
| Métrica | Valor |
|--------|-------|
| delivery_ratio | 0.0278 |
| latency_mean | 5908.6538 |
| overhead_ratio | 37.6923 |
| drop_ratio | 1.3811563169164882 |
