## Escenario R5 — R5_MountainRescue

### 1. Visión general

- **Scenario ID:** R5  
- **Nombre:** R5_MountainRescue  
- **Familia:** Rural  
- **Fichero settings:** `corpus_v1/04_rural/R5_MountainRescue.settings`

**Objetivo**

Mensajes críticos pequeños, TTL corto. Alertas de rescate en montaña.
...
|---------|-------|------------|
| world_area | 51000000 | Área total de simulación (m^2) |
...
| wait_mean | 120 | Tiempo medio de pausa/espera (s) |
...
| event_interval_mean | 47.5 | Media del intervalo de Events1 |
| event_size_mean | 3000 | Tamaño medio de Events1 (bytes) |
...
RandomWaypoint, msgTtl 10 min, cargas pequeñas (1–5 kB).
