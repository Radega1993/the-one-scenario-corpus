## Escenario R7 — R7_SparseTinyBuffer

### 1. Visión general

- **Scenario ID:** R7  
- **Nombre:** R7_SparseTinyBuffer  
- **Familia:** Rural  
- **Fichero settings:** `corpus_v1/04_rural/R7_SparseTinyBuffer.settings`

**Objetivo**

Fuerte presión de buffer (buffer pequeño, tráfico moderado).
...
|---------|-------|------------|
| world_area | 71250000 | Área total de simulación (m^2) |
...
| wait_mean | 250 | Tiempo medio de pausa/espera (s) |
...
| transmitRange | 12 | Alcance de interfaz (m) |
| bufferSize | 500000 | Node buffer (bytes) |
| transmitSpeed | 1850000 | Velocidad de interfaz (bytes/s) |
| msgTtl | 120 | TTL de mensajes |
| event_interval_mean | 27.5 | Media del intervalo de Events1 |
| event_size_mean | 140000 | Tamaño medio de Events1 (bytes) |
...
RandomWaypoint, bufferSize 500k, tasa de eventos moderada.
