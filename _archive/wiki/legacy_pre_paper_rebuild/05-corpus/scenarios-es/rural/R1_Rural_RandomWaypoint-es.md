## Escenario R1 — R1_Rural_RandomWaypoint

### 1. Visión general

- **Scenario ID:** R1  
- **Nombre:** R1_Rural_RandomWaypoint  
- **Familia:** Rural  
- **Fichero settings:** `corpus_v1/04_rural/R1_Rural_RandomWaypoint.settings`

**Objetivo**

Mundo grande, pocos nodos (rural disperso). Baseline RandomWaypoint para regímenes rurales tolerantes al retardo.
...
|---------|-------|------------|
| world_area | 180000000 | Área total de simulación (m^2) |
...
| wait_mean | 360 | Tiempo medio de pausa/espera (s) |
...
RandomWaypoint sobre 15×12 km, 25 nodos, baja densidad.
