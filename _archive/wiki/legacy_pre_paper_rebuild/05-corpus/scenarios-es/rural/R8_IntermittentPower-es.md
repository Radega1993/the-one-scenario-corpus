## Escenario R8 — R8_IntermittentPower

### 1. Visión general

- **Scenario ID:** R8  
- **Nombre:** R8_IntermittentPower  
- **Familia:** Rural  
- **Fichero settings:** `corpus_v1/04_rural/R8_IntermittentPower.settings`

**Objetivo**

Nodos "duermen" parte del tiempo (activeTimes). Conectividad intermitente.
...
| transmitSpeed | 1750000 | Velocidad de interfaz (bytes/s) |
| msgTtl | 10000 | TTL de mensajes |
| event_interval_mean | 82.5 | Media del intervalo de Events1 |
...
RandomWaypoint con ventanas activeTimes (1 h on, 1 h off).
