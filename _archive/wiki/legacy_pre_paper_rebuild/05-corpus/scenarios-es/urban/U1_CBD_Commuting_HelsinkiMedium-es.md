## Escenario U1 — U1_CBD_Commuting_HelsinkiMedium

### 1. Visión general

- **Scenario ID:** U1
- **Nombre:** U1_CBD_Commuting_HelsinkiMedium
- **Familia:** Urban
- **Fichero settings:** `corpus_v1/01_urban/U1_CBD_Commuting_HelsinkiMedium.settings`

**Objetivo**

Desplazamientos al CBD con oficinas concentradas y picos de mañana/tarde. Baseline WorkingDayMovement para DTN urbano.
