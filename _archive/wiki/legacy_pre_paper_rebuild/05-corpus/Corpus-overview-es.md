...
- [Escenarios urbanos](Urban-scenarios-es) — U1–U7  
- [Escenarios campus](Campus-scenarios-es) — C1–C6  
- [Escenarios vehículos](Vehicle-scenarios-es) — V1–V5  
...
- **[Catálogo de escenarios](Scenario-catalog-es)** — Índice por familia con enlaces a cada página de familia.
- **[Detalle de escenarios](Scenario-details-es)** — Lista completa de los 60 escenarios con enlaces a la documentación por escenario (EN/ES).

---

## Ver también

- [Scenario-families-es](Scenario-families-es) — Resumen por familia
- [Corpus-versioning-es](Corpus-versioning-es) — Conjunto oficial congelado y reglas de evolución
- [Dropped-scenarios-evolution-es](Dropped-scenarios-evolution-es) — Motivos de descarte/movimiento
