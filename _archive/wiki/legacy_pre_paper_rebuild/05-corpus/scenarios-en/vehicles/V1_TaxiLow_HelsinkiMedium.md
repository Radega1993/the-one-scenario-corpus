## Scenario V1 — V1_TaxiLow_HelsinkiMedium

### 1. Overview

- **Scenario ID:** V1
- **Name:** V1_TaxiLow_HelsinkiMedium
- **Family:** Vehicles
- **Settings file:** `corpus_v1/03_vehicles/V1_TaxiLow_HelsinkiMedium.settings`

**Objective**

Low taxi density: few MapRouteMovement taxis over Helsinki. Tests DTN under sparse vehicular mobility.
