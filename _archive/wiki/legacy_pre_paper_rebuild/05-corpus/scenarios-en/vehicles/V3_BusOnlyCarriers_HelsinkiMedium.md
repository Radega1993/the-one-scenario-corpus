## Scenario V3 — V3_BusOnlyCarriers_HelsinkiMedium

### 1. Overview

- **Scenario ID:** V3
- **Name:** V3_BusOnlyCarriers_HelsinkiMedium
- **Family:** Vehicles
- **Settings file:** `corpus_v1/03_vehicles/V3_BusOnlyCarriers_HelsinkiMedium.settings`

**Objective**

Buses only as message carriers. Pedestrians generate traffic; buses relay. Tests DTN under bus-centric mobility.
