## Scenario T6 — T6_UniformSources_RandomFromTo

### 1. Overview

- **Scenario ID:** T6
- **Name:** T6_UniformSources_RandomFromTo
- **Family:** Traffic
- **Settings file:** `corpus_v1/07_traffic/T6_UniformSources_RandomFromTo.settings`

**Objective**

Uniform sources: random source–destination pairs. Baseline traffic pattern.
