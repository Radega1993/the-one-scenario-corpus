## Scenario T12 — T12_TTL_Infinite_Buffer200M

### 1. Overview

- **Scenario ID:** T12
- **Name:** T12_TTL_Infinite_Buffer200M
- **Family:** Traffic
- **Settings file:** `corpus_v1/07_traffic/T12_TTL_Infinite_Buffer200M.settings`

**Objective**

Infinite TTL and 200 MB buffer. No expiration; tests protocol under relaxed constraints.
