## Scenario T4 — T4_VeryShortTtl_5to10min

### 1. Overview

- **Scenario ID:** T4
- **Name:** T4_VeryShortTtl_5to10min
- **Family:** Traffic
- **Settings file:** `corpus_v1/07_traffic/T4_VeryShortTtl_5to10min.settings`

**Objective**

Very short TTL (5–10 min). Time-critical delivery; messages expire quickly.
