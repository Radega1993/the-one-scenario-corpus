## Scenario S4 — S4_RandomMixing_NoHotspots

### 1. Overview

- **Scenario ID:** S4
- **Name:** S4_RandomMixing_NoHotspots
- **Family:** Social
- **Settings file:** `corpus_v1/06_social/S4_RandomMixing_NoHotspots.settings`

**Objective**

Random mixing with no hotspots. Uniform contact distribution; baseline for comparison with structured (S1, S3, S6) scenarios.
