## Escenario V3 — V3_BusOnlyCarriers_HelsinkiMedium

### 1. Visión general

- **Scenario ID:** V3
- **Nombre:** V3_BusOnlyCarriers_HelsinkiMedium
- **Familia:** Vehicles
- **Fichero settings:** `corpus_v1/03_vehicles/V3_BusOnlyCarriers_HelsinkiMedium.settings`

**Objetivo**

Solo buses como portadores de mensajes. Peatones generan tráfico; buses hacen relay. Prueba DTN bajo movilidad centrada en buses.
...
- **Más similares (top 3):**
  - U2_SparseSuburb_HelsinkiMedium — r ≈ **0.70**
  - U1_CBD_Commuting_HelsinkiMedium — r ≈ **0.55**
  - U6_OfficeWaitHeavyTail_HelsinkiMedium — r ≈ **0.48**
- **Más diferentes (top 3)** (menor |r|):
  - R11_SpeedExtremeLow — r ≈ **0.00**
...
| Métrica | Valor |
|--------|-------|
| delivery_ratio | 0.2276 |
| latency_mean | 3728.1967 |
| overhead_ratio | 2.1205 |
| drop_ratio | 0.9033584647018505 |
