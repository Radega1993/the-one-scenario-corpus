...
**Total paper benchmark:** **540** simulaciones en este directorio. El nombre histórico `corpus_v2` fue renombrado en la reorganización de 2026-05-27 (ver [`../CHANGELOG.md`](../CHANGELOG.md)).
...
- Manifest (alias combinado): [`../analysis/data/corpus_v1_combined_manifest.csv`](../analysis/data/corpus_v1_combined_manifest.csv)
