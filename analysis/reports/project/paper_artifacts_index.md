...
| Spatial Occupancy / Useful Time | Spatial summary | `scenarios/analysis/reports/spatial/spatial_occupancy_analysis_summary.md` | report | partial | Spatial dataset currently legacy-720 fallback |
| Benchmark Reproducibility | Reproducibility guide | `scenarios/REPRODUCIBILITY.md` | doc | ready | End-to-end reproduction commands |
| Results | Paper figures | `scenarios/analysis/figures/paper/main/` | figures | ready | Final figures for manuscript |
| Results | Paper tables | `scenarios/analysis/figures/paper/tables/` | tables | ready | Final EN/ES table set |
| Limitations | Consistency report | `scenarios/analysis/reports/project/final_artifact_consistency_report.md` | report | ready | Explicit WARN items to disclose |
| Supplementary Material | Supplementary figures | `scenarios/analysis/figures/paper/supplementary/` | figures | ready | Extra diagnostics/appendix |
| Wiki companion | Wiki sync audit | `scenarios/analysis/reports/wiki_meta/wiki_final_sync_audit.md` | report | ready | 0 broken links after cleanup |