...
| C003 | combined_manifest_rows | 540 | 540 | PASS | BLOCKER | rebuild combined manifest from corpus_v1 |
| C004 | output_metrics_rows | 540 | 540 | PASS | MAJOR | rerun output_metrics for missing reports |
| C005 | features_rows | 540 | 540 | PASS | MAJOR | rerun features phase |
| C006 | spatial_metrics_scope | 540 or missing | 540 | PASS | INFO | none |
| C007 | no__refs | 0 | 5663 | FAIL | BLOCKER | remove  references from active tree |
| C008 | active corpus_v2 refs outside archive | 0 (except legacy context) | 25 | WARN | MAJOR | review docs/scripts and keep only legacy context |
| C009 | active corpus_v3 refs outside archive | 0 (except legacy context) | 14 | WARN | MINOR | review historical mentions |
| C010 | active 720 refs outside archive | historical context only | 119 | WARN | MINOR | mark as historical or update to 540 |
