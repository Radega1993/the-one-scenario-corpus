# Informe piloto (corpus_v2) — 3 bases x 12 perfiles (36 simulaciones)

Generado: 2026-04-29 12:46

Fuentes:
- `scenarios/analysis/data/output_metrics.csv`
- `scenarios/analysis/data/indirect_features_diego.csv`

Bases evaluadas: `U1_CBD_Commuting_HelsinkiMedium`, `R1_Rural_RandomWaypoint`, `D2_PartitionedCity_MuleBridge`.
Perfiles evaluados: `TP01..TP12` (incluye `TP06_OneToMany`, `TP11_ManyToOne`, `TP12_GroupToGroup`).

## Resumen por perfil (media en 3 escenarios base)
...
| TP06 | 0.3522 | 8272.1 | 21.7306 |
| TP07 | 0.3421 | 15545.4 | 0.0000 |
| TP08 | 0.2433 | 10169.6 | 38.5670 |
| TP09 | 0.2126 | 9917.5 | 46.1613 |
| TP10 | 0.0858 | 1943.9 | 7.2258 |
| TP11 | 0.3869 | 8895.4 | 0.0000 |
| TP12 | 0.1786 | 13412.2 | 26.6217 |

## Señales rapidas (ranking)

**Top 5 delivery_ratio**
- `U1_CBD_Commuting_HelsinkiMedium__TP11_ManyToOne`: delivery_ratio=0.7247, drop_ratio=0.0000
- `D2_PartitionedCity_MuleBridge__TP02_LowLoad`: delivery_ratio=0.6947, drop_ratio=0.0000
- `U1_CBD_Commuting_HelsinkiMedium__TP06_OneToMany`: delivery_ratio=0.6144, drop_ratio=64.1010
- `D2_PartitionedCity_MuleBridge__TP07_BurstWindow`: delivery_ratio=0.5481, drop_ratio=0.0000
- `U1_CBD_Commuting_HelsinkiMedium__TP12_GroupToGroup`: delivery_ratio=0.5358, drop_ratio=79.8650

**Bottom 5 delivery_ratio**
- `D2_PartitionedCity_MuleBridge__TP12_GroupToGroup`: delivery_ratio=0.0000, drop_ratio=0.0000
- `R1_Rural_RandomWaypoint__TP01_Baseline`: delivery_ratio=0.0000, drop_ratio=0.0000
- `R1_Rural_RandomWaypoint__TP02_LowLoad`: delivery_ratio=0.0000, drop_ratio=0.0000
- `R1_Rural_RandomWaypoint__TP03_ManySmall`: delivery_ratio=0.0000, drop_ratio=0.0000
- `R1_Rural_RandomWaypoint__TP04_FewLarge`: delivery_ratio=0.0000, drop_ratio=0.0000

**Top 5 drop_ratio (peor congestion/expiracion)**
- `U1_CBD_Commuting_HelsinkiMedium__TP08_HubTarget`: drop_ratio=112.8124, delivery_ratio=0.3258
- `U1_CBD_Commuting_HelsinkiMedium__TP12_GroupToGroup`: drop_ratio=79.8650, delivery_ratio=0.5358
- `D2_PartitionedCity_MuleBridge__TP09_Bimodal`: drop_ratio=78.4347, delivery_ratio=0.3333
- `D2_PartitionedCity_MuleBridge__TP04_FewLarge`: drop_ratio=66.6354, delivery_ratio=0.2873
- `U1_CBD_Commuting_HelsinkiMedium__TP06_OneToMany`: drop_ratio=64.1010, delivery_ratio=0.6144
...
## Observaciones para decision de escalado

- Si `TP06_OneToMany`, `TP11_ManyToOne` y `TP12_GroupToGroup` muestran separacion consistente frente a TP baseline, se justifica escalar al corpus completo.
- `R1` se mantiene como caso extremo de baja/no conectividad; util para control, pero no debe ser el unico rural al escalar.
- Para comparacion robusta entre protocolos, ejecutar multiples seeds por perfil (minimo 3, recomendable 5).
