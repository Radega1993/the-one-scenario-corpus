...
- Scenarios with `pct_messages_last_10` in [10%, 12%]: **267** (`sensitivity_required`).
- Pearson correlation `pct_messages_last_10` vs `delivery_ratio` (connected scenarios, n=540): **r = -0.1946**.
...
|----|--------|----------|-------------------|------------------|----------|
| TP01 | full_simulation | 0.500 | 10.15 | 10.03 | complete_window |
| TP02 | full_simulation | 0.496 | 10.42 | 9.99 | sensitivity_required |
| TP03 | full_simulation | 0.500 | 9.96 | 9.99 | complete_window |
| TP04 | full_simulation | 0.504 | 9.64 | 9.78 | complete_window |
| TP05 | full_simulation | 0.500 | 10.15 | 10.03 | complete_window |
...
| `U2_SparseUrban_HelsinkiDowntown__TP02_LowLoad` | TP02 | 11.3 | 0.3196 |
| `R2_VillagesTrails_InterVillage__TP02_LowLoad` | TP02 | 11.3 | 0.6804 |
