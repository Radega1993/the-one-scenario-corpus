...
Generated: 2026-05-24 11:14 UTC
...
- **Corpus:** corpus_v2 — 720 simulations (60 bases × 12 Traffic Profiles).
...
- Scenarios with `pct_messages_last_10` in [10%, 12%]: **333** (`sensitivity_required`).
- Pearson correlation `pct_messages_last_10` vs `delivery_ratio` (connected scenarios, n=670): **r = -0.1332**.
...
|----|--------|----------|-------------------|------------------|----------|
| TP01 | full_simulation | 0.500 | 10.14 | 10.00 | complete_window |
| TP02 | full_simulation | 0.496 | 10.43 | 10.08 | sensitivity_required |
| TP03 | full_simulation | 0.500 | 9.97 | 10.01 | complete_window |
| TP04 | full_simulation | 0.504 | 9.60 | 9.82 | complete_window |
| TP05 | full_simulation | 0.500 | 10.14 | 10.00 | complete_window |
| TP06 | directional | 0.498 | 10.01 | 10.20 | sensitivity_required |
| TP07 | burst_only | 0.240 | 0.00 | 0.00 | burst_exception |
| TP08 | directional | 0.498 | 10.01 | 10.19 | sensitivity_required |
| TP09 | full_simulation | 0.501 | 9.82 | 9.96 | complete_window |
| TP10 | full_simulation | 0.500 | 10.08 | 9.93 | stress_profile |
| TP11 | directional | 0.498 | 10.01 | 10.20 | sensitivity_required |
| TP12 | directional | 0.504 | 9.85 | 9.62 | complete_window |

### Outlier scenarios (highest % last 10%)

| Scenario | TP | % last 10 | delivery_ratio |
|----------|-----|----------:|---------------:|
| `R5_MountainRescue__TP02_LowLoad` | TP02 | 12.1 | 0.0303 |
| `D7_HighLoad_TrafficStorm__TP02_LowLoad` | TP02 | 12.1 | 0.3333 |
| `C6_EmergencyDrill_Evacuation__TP02_LowLoad` | TP02 | 11.8 | 0.6471 |
| `R4_ParkRangers_HelsinkiMedium__TP02_LowLoad` | TP02 | 11.5 | 0.5208 |
| `R6_SparseLongRange__TP02_LowLoad` | TP02 | 11.5 | 0.0208 |
| `T11_TTL_1min__TP02_LowLoad` | TP02 | 11.5 | 0.7813 |
| `T13_Buffer_256k__TP02_LowLoad` | TP02 | 11.5 | 0.0104 |
| `U2_SparseSuburb_Manhattan__TP02_LowLoad` | TP02 | 11.3 | 0.3299 |
