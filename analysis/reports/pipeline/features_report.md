...
| `Group10.routeFile` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group10.routeType` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group11.groupID` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group11.routeFile` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group11.routeType` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group12.groupID` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group12.routeFile` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group12.routeType` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group13.groupID` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group13.routeFile` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group13.routeType` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
...
| `Group3.routeFile` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group3.routeType` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group4.groupID` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group4.routeFile` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group4.routeType` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group5.groupID` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group5.routeFile` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group5.routeType` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group6.groupID` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group6.routeFile` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group6.routeType` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group7.groupID` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group7.routeFile` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group7.routeType` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group8.groupID` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group8.routeFile` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group8.routeType` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group9.groupID` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group9.routeFile` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
| `Group9.routeType` | DESCARTADO: Ver ../docs/features_decision.md (variante de grupo o misma categoría que Group/Group1). |
