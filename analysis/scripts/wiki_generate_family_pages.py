...
FAMILIES: dict[str, dict] = {
    "02_campus": {
        ...
        "base_count": 6,
        "corpus_count": 72,
        "finalize_cmd": "scenarios/analysis/.venv/bin/python scenarios/setup/finalize_kumpula_campus.py --apply --install",
    ...
    "03_vehicles": {
        ...
        "base_count": 5,
        "corpus_count": 60,
        "finalize_cmd": "scenarios/analysis/.venv/bin/python scenarios/setup/finalize_manhattan_midtown.py --apply --install",
    ...
    "04_rural": {
        ...
        "finalize_cmd": "scenarios/analysis/.venv/bin/python scenarios/setup/finalize_nuuksio_sparse_trails.py --apply --install",
    ...
    "05_disaster": {
        ...
        "finalize_cmd": "scenarios/analysis/.venv/bin/python scenarios/setup/finalize_helsinki_disrupted.py --apply --install",
    ...
    "06_social": {
        ...
        "base_count": 6,
        "corpus_count": 72,
        "finalize_cmd": "scenarios/analysis/.venv/bin/python scenarios/setup/finalize_kallio_community_compact.py --apply --install",
